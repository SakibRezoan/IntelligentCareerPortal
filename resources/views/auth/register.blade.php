...
<div class="container-fluid">
    <div class="row-fluid" >
        <div class="col-md-offset-4 col-md-4" id="box">
            <h2 class="auth-header">User Registration</h2>
            <hr>
                ...
                <fieldset>
                    ...
                    <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                        <div class="col-offset-1 col-md-10 col-md-offset-1">
                            <div class="input-group">
                                ...
                                <input id="name" placeholder="Enter Username" type="text" class="form-control" name="name" value="{{ old('name') }}" required autofocus>
                                @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-lg-offset-3">
                            <div class="form-group">
                                <button type="submit" class="btn btn-success btn-group btn-block btn-lg">Register</button>
                                <a class="btn btn-link text-center" href="{{ route('login') }}" data-toggle="modal">
